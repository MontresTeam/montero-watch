...
function OrderContent() {
  ...
  return (
    <div className="container mx-auto px-3 py-4 sm:py-6 md:py-8 lg:py-12 max-w-7xl">
      <form onSubmit={handlePlaceOrder} className="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-6 md:gap-8 lg:gap-12">
          ...
          <div className="flex flex-col h-full">
            <div className="flex-1">
              ...
              <div className="space-y-3 sm:space-y-4 mb-6 sm:mb-8">
                {/* Product Card */}
                <div className="bg-white p-3 sm:p-4 rounded-xl border border-gray-200 shadow-sm relative">
                  <button 
                    onClick={() => window.history.back()}
                ...
                <div className="space-y-3 sm:space-y-4">
                  ...
                  <div className="flex justify-between items-center">
                    <div className="flex flex-col">
                      ...
                      <span className="text-xs text-gray-500">({quantity} item{quantity > 1 ? 's' : ''})</span>
                    </div>
            ...
            <div className="mt-6 sm:mt-8">
              ...
              <div className="flex flex-col-reverse xs:flex-row gap-3 sm:gap-4 mb-4 sm:mb-6">
                ...
                <button 
                  type="submit"
                  disabled={submitting}
                  className={`flex-1 px-5 sm:px-6 py-3 bg-black text-white rounded-lg text-sm font-medium hover:bg-gray-800 transition-colors flex items-center justify-center gap-2 ${submitting ? 'opacity-50 cursor-not-allowed' : ''}`}
                >
