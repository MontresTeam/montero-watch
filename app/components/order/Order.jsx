            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <div className="absolute right-4 top-1/2 -translate-y-1/2 pointer-events-none text-xs text-gray-500">
                    ▼
                  </div>
                </div>
              </div>
                ...
                <div className="flex flex-col sm:flex-row justify-between items-end gap-4 mb-4">
                  ...
                  <div className="flex flex-col items-center gap-1 flex-shrink-0">
                    ...
                    <div className="flex items-center border border-gray-200 rounded-md bg-white">
                      <button className="px-3 py-1 text-gray-500 hover:text-black">
                        -
                      </button>
